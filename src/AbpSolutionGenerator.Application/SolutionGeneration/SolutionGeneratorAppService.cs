...
{
    public class SolutionGeneratorAppService : ApplicationService, ISolutionGeneratorAppService
    {
        ...
        private async Task GenerateMicroserviceAsync(string solutionPath, SolutionGenerationRequest request, MicroserviceRequest microservice)
        {
            ...
            foreach (var project in projects)
            {
                ...
                // إنشاء ملف المشروع
                var projectContent = GenerateProjectFileContent(project, microservice);
        ...
        private string GenerateProjectFileContent(string projectName, MicroserviceRequest microservice)
        {
  ...
  <ItemGroup>
    <PackageReference Include=""Volo.Abp.Core"" Version=""9.2.0"" />
  </ItemGroup>
...
";
        ...
        {
            // Create Program.cs, appsettings.json, etc.
            await Task.CompletedTask;
        }
  ...
  <ItemGroup>
    ...
    <PackageReference Include=""Volo.Abp.AspNetCore.Components.WebAssembly.LeptonXLiteTheme"" Version=""9.2.0"" />
  </ItemGroup>
</Project>";
        }
  ...
  <ItemGroup>
    ...
    <PackageReference Include=""Volo.Abp.OpenIddict.AspNetCore"" Version=""9.2.0"" />
  </ItemGroup>
</Project>";
        }
  ...
  <ItemGroup>
    <PackageReference Include=""Volo.Abp.Localization"" Version=""9.2.0"" />
  </ItemGroup>
</Project>";
        }
