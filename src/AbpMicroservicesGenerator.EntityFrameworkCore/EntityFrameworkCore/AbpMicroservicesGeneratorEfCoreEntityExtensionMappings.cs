...
public static class AbpMicroservicesGeneratorEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE AbpMicroservicesGeneratorModuleExtensionConfigurator CLASS (in the Domain.Shared project)
