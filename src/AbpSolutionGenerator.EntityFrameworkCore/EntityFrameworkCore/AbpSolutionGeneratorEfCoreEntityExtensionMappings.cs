...
public static class AbpSolutionGeneratorEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE AbpSolutionGeneratorModuleExtensionConfigurator CLASS (in the Domain.Shared project)
