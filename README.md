...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p dbb60e1a-1722-4bd6-98f4-c1fd6e4a10b2
```

> `dbb60e1a-1722-4bd6-98f4-c1fd6e4a10b2` is the password of the certificate, you can change it to any password you want.
